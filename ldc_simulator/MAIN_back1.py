...
if __name__ == '__main__':
    ...
    dict_cases = {0:None, 
                ...
                253:'basic_all_k256_auto_d1s',
                254:'basic_wh_k256_auto_d1s',
                255:'advanced_all_k256_auto_d1s',
                256:'advanced_wh_k256_auto_d1s',
                }
    ...
    if simulation==1:
        ...
        dt = pd.date_range(start='2019-1-1 00:00', end='2020-1-1 00:00').tz_localize('Pacific/Auckland')
