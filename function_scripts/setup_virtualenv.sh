...
# For this particular project, install gridlabd from dchassin's repo which is more updated
#sudo svn checkout https://github.com/dchassin/gridlabd.git gridlabd
#cd gridlabd/trunk
#sudo autoreconf -isf
#sudo ./configure
#sudo make install
#sudo gridlabd --validate
