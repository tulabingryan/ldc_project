            ...
            try:
                ...
                if self.dict_dongles:
                    ...
                    if len(dict_data.keys())>10:
                        ...
                        dict_data = self.pickle_data(dict_data=dict_data, path=f'history/h{self.local_ip.split(".")[2]}_{today}.pkl.xz')
                    time.sleep(0.7)
            except Exception as e:
        ...
        while self.dict_common['is_alive']:
            try:
                ...
                if False: #self.dict_sensors:
                    ...
                    df_hist = pd.melt(df_hist.astype(str), id_vars=["unixtime", "group", "location"], var_name="parameter", value_name="value")
