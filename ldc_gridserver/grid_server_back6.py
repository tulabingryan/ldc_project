...
global dict_cmd, cmd_algorithm, cmd_loading, previous_limit, ldc_signal, latest_demand, df_data, df_data_cols, display_limit, df_data_cols
display_limit =True
...
def write_rs232(msg):
    ...
    try:
        ...
        print("Error send_command write_rs232:", e)
...
def update_graph(json_data):  
    ...
    trace_actual = go.Scattergl(
                ...
                y = df_data_graph['power_sum'],  # agg_demand
                name = 'Demand',
    ...
    trace_limit = go.Scattergl(
                x = df_data_graph.index, 
                y = df_data_graph['agg_limit'] * 0.001,
                name = 'Limit',
